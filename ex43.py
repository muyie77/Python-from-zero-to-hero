    ...
    def enter(self):
        ...
        if action == 1:
            print(dedent("""
                    ...
                    around his body, which throws off your aim. Your laser hits
                    his costume but misses him entirely. This completely ruins
                    his brand new costume his mother bought him, which makes him
                    fly into an insane rage and blast you repeatedly in the face
                    until you are dead. The he eats you.
                    """))
            return "death"
            ...
            print(dedent("""
                    ...
                    right as Gothon's blaster cranks a laser pasy your head.
                    In the middle of your artful dodge your foot slips and you
                    bang your head on the metal wall and pass out. You woke up
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
                You do a five roll into the Weapon Armory, crouch and scan the
                room for more Gothons that might be hiding. It's dead quiet,
                too quiet . You stand up and run to the far side of the room and
                find the neutron bomb in itsc container.
                There's a keypad lock on the box and you need the code to get
                the bomb out. If you get the code wrong 10 times then the lock
        ...
        if guess == code:
            print(dedent("""
                    ...
                    as fast as you can to the bridge where you must
            ...
            print(dedent("""
                    The lock buzzes one last time and then you here a
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
                You burst into the Bridge with the neutron destruct bomb under
                ...
                the last. They haven't pull their weapons out yet, as they see
                the active bomb under your arm and don't want to set it off.

                What will you do?
                """))
        print(dedent("""1. Throw the bomb
        ...
        if action == 1:
            print(dedent("""
                    ...
                    shoots you right in back killing you. As you die you see
            ...
            print(dedent("""
                    ...
                    backword to the door, open it, and then carefully place the
                    bomb on the floor, pointing your blaster at eat. You then
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
                ...
                to the escape pod before the whole ship explodes. It seems like
                hardly any Gothons are on the ship, so your run is clear of
                interference You get to the chamber with the escape pods, and
                now need to pick one to take. Some of them could be damaged but
                you but you don't have time to look. There's 5 pods, which one
                do you take?
                """))
